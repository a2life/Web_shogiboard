...
buttonBar block is dynamically created if "moves" exists and  need to be outside of "forSnapshot" Div,
This is because the "forSnapShot" content copy is created everytime the move is made.
