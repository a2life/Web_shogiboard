...
$packageNameLower = 'shogiboard'; /* No spaces, no dashes */

$components = array(
    /* These are used to define the package and set values for placeholders */
    'packageName' => 'shogiboard',  /* No spaces, no dashes */
    'packageNameLower' => $packageNameLower,
    'packageDescription' => 'modx shogiboard package',
    'version' => '1.0.0',
    'release' => 'beta1',
    'author' => 'A2life',
    'email' => '<http://shogishack.net>',
    'authorUrl' => 'http://shogishack.net',
    'authorSiteName' => "Shogi Shack",
    'packageDocumentationUrl' => 'http://github.com/a2life/web_shogiboard',
    'copyright' => '2012',

    /* no need to edit this except to change format */
    'createdon' => strftime('%m-%d-%Y'),

    'gitHubUsername' => 'A2life',
    'gitHubRepository' => 'web_shogiboard',
    ...
    'componentsRoot' => $this->modx->getOption('mc.root', null,
        MODX_CORE_PATH . 'components/'),
    /* path to MyComponent source files */
    'componentCore' => $this->modx->getOption('mc.core_path', null,
        MODX_CORE_PATH . 'components/core/components/'),
    /* path to new project root */
    'targetRoot' => MODX_ASSETS_PATH . 'components/' . $packageNameLower . '/',
...
*/
    ...
    */
    ...
    'namespaces' => array(
        'example' => array(
            'name' => 'shogiboard',
            'path' => '{core_path}components/',
            'assets_path' => '{assets_path}components/shogiboard/',
        ),
...
*/
    ...
    */
    ...
    'elements' => array(
        ...
        'propertySet1' => array( /* all three fields are required */
            'default' => array(
                'name' => 'PropertySet1',
                'description' => 'define shboard defaults',
                'category' => 'shogiboard',
            ),
            'PropertySet2' => array(
                'hidetchi' => 'PropertySet2',
                'description' => 'Hidetchi piece set',
                'category' => 'shogiboard',
            ),
        ),
 ...
 /*           'Snippet1' => array(
                'category' => 'shogiboard',
                'description' => 'shogiboard animater',
                'static' => true,
            ),
 */
