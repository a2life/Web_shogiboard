This is a readme file for shogiboard for javascript.  the files in this folder will work only with html page
with Javascript and css style sheets.
See shogiboard.html for demo.
...
一応動きますが、表示内容の充実、盤面配置の調整などはこれからです。
